%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%% last update 29 November 2021, lnev %%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Paul Harrisson
...
% This code computes the density of states in 2D and 3D. It allows to see
% how close is the 2D DOS to the 3D. Moreover, the code take care of the
% non-parabolicity of the band via the parameter "alpha". Increasing the
% resolution of the grid z by reducing dz is making the code more accurate.
